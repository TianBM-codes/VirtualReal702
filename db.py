...
CREATE_TABLE_SQL_LIST = [
    ...
    CREATE TABLE IF NOT EXISTS t_mt_py_fem_selected_parameter (
        ...
        lower DOUBLE NOT NULL DEFAULT 0 COMMENT 'lower bound',
        upper DOUBLE NOT NULL DEFAULT 0 COMMENT 'upper bound',
        prob_id BIGINT NOT NULL DEFAULT 0 COMMENT 'problem id',
