...
def append_update_history(
    ...
    ccabs, rel_res, dx_norm, max_abs_dparam,
):
    header = [
    ...
    row = [
        ...
        float(ccabs), float(rel_res),
        float(dx_norm), float(max_abs_dparam),
    ]
...
def main():
    ...
    for it in range(1, cfg.MAX_ITERS + 1):
        ...
        append_update_history(
            ...
            ccabs=ccabs, rel_res=best_rel_res,
